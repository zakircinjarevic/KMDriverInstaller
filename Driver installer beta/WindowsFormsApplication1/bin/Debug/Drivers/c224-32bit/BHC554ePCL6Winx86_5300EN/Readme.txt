...
Please read the following notes before use.
 ...
 4. When the driver installed in Windows Server 2008 is shared and installing 
    ...
    ==>In the case, please install the printer driver in the way described below.
      4-1. Please prepare the driver to add Windows Vista or Windows Server 2008 and 
...
==========================================================================================
 ...
 11. OS Restrictions
  ...
  11-3. Watermark and FAX Cover Sheet on Windows Vista x64
  ...
  11-5. Using a WSD Port Connection in Windows 7 and Windows Server 2008 R2
  ...
  11-6. About Watermark printing in Windows 8.1 
  ...
  11-13. About [Print Host Image] or [Print Device Image] printing in Windows 8.1
         In some instances, [Print Host Image] or [Print Device Image] is not printed when the print is executed 
         from Microsoft Word 2010 or Microsoft Excel 2010.
         - Printer Property -> [Settings]Tab - [EMF Spool] -> ON
         - Printer Property -> [Advaced]Tab - [Enable advanced printing features] -> ON

  11-14. Restriction of Cover Sheet in Windows 8.1 x86
...
==========================================================================================
 ...
 2. Adobe Acrobat
  ...
  2-5. When printing landscape original using Acrobat Reader 9 on Windows Vista x64 SP2, 
       the first page will be printed as portrait original.
       ==>In this case, it can be printed normally when [Auto-Rotate and Center] is 
          specified to OFF in the [Print Setting] of application.

  2-6. Please note that entering multiple copies in the Print Dialog menu will not 
  ...
  2-7. When [Select paper by corresponding to PDF's page size] setting available
